            ...
            <div className="stats-container">
                ...
                <div className={ "stats-wrap" } >
                    ...
                    <div className={ "stats-block" } >
                        ...
                        <div className={ "stats-block-content" }>
                            <div>
                                <span className={ "stats-block-content-title" }> New project request </span>
                                <span className={"stats-block-content-value"}> <></> </span>
                            </div>
                            <Link to="/project/request/new"> Adaugă <svg xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 24 24" fill="none">
                                <path d="M4 12H20M20 12L16 8M20 12L16 16" stroke="#FFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></Link>
                        </div>
                    </div>
                    ...
                    <div className={ "stats-block" } >
                        ...
                        <div className={"stats-block-content"}>
                            <div>
                                <span className={"stats-block-content-title"}> Solicitare de HUMINT </span>
                                <span className={"stats-block-content-value"}> <></> </span>
                            </div>
                            <Link to="/humint/new"> Adaugă <svg xmlns="http://www.w3.org/2000/svg" width="15px"
                    ...
                    <div className={ "stats-block" } >
                        ...
                        <div className={"stats-block-content"}>
                            <div>
                                <span className={"stats-block-content-title"}> Analiști implicați </span>
                                <span className={"stats-block-content-value"}> { stats?.analyst?.free }/{ stats?.analyst?.total } </span>
                            </div>
                            <Link to="/users"> Vezi utilizatorii <svg xmlns="http://www.w3.org/2000/svg" width="15px"
                                                                         height="15px" viewBox="0 0 24 24" fill="none">
                                <path d="M4 12H20M20 12L16 8M20 12L16 16" stroke="#FFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></Link>
                        </div>
                    ...
                    <div className={"stats-block"}>
                        ...
                        <div className={"stats-block-content"}>
                            <div>
                                <span className={"stats-block-content-title"}> Finalizate </span>
                                <span className={"stats-block-content-value"}> {stats?.completed} </span>
                            </div>
                            {/*<Link to="/users"> Vezi utilizatorii <svg xmlns="http://www.w3.org/2000/svg" width="15px"
                                                                         height="15px" viewBox="0 0 24 24" fill="none">
                                <path d="M4 12H20M20 12L16 8M20 12L16 16" stroke="#FFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div className={ "stats-block" } >
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#666569" width="30px" height="30px"  viewBox="0 0 1920 1920">
                            <g fill-rule="evenodd">
                        ...
                        <div className={"stats-block-content"}>
                            <div>
                                <span className={"stats-block-content-title"}> Solicitări proiect — de revizuit </span>
                                <span className={"stats-block-content-value"}> {stats?.requested?.projects} </span>
                            </div>
                            <Link to="/project/request"> Deschide lista <svg xmlns="http://www.w3.org/2000/svg" width="15px"
                                                                         height="15px" viewBox="0 0 24 24" fill="none">
                                <path d="M4 12H20M20 12L16 8M20 12L16 16" stroke="#FFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></Link>
                        </div>
                    ...
                    <div className={ "stats-block" } >
                        ...
                        <div className={"stats-block-content"}>
                            <div>
                                <span className={"stats-block-content-title"}> Solicitări HUMINT — de aprobat </span>
                                <span className={"stats-block-content-value"}> {stats?.requested?.huments} </span>
                            </div>
                            <Link to="/humint"> Verifica acum <svg xmlns="http://www.w3.org/2000/svg" width="15px"
                                                                         height="15px" viewBox="0 0 24 24" fill="none">
                                <path d="M4 12H20M20 12L16 8M20 12L16 16" stroke="#FFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></Link>
                        </div>
                    ...
                    <div className={ "stats-block" } >
                        ...
                        <div className={"stats-block-content"}>
                            <div>
                                <span className={"stats-block-content-title"}> Mesaje necitite </span>
                                <span className={"stats-block-content-value"}> { stats?.messages } </span>
                            </div>
                            <Link to="/messenger"> Deschide messenger <svg xmlns="http://www.w3.org/2000/svg" width="15px"
                                                                         height="15px" viewBox="0 0 24 24" fill="none">
                                <path d="M4 12H20M20 12L16 8M20 12L16 16" stroke="#FFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></Link>
                        </div>
